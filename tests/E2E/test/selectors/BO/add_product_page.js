module.exports = {
  AddProductPage: {
    ...
    bulk_actions_bloc: '//*[@id="bulk-combinations-container"]',
    ...
    combination_size: '//*[@id="attribute-group-1"]//label[@for="attribute-%ID"]',
    combination_size_input: '#attribute-%ID',
    close_combination: '(//*[@id="attributes-generator"]/div[@class="row"]//a)[1]',
    combination_attribute_span: '//*[@id="attributes-generator"]/div[@class="row"]//span[contains(text(), "%Att")]',
    ...
    combination_quantity_input: '//*[@id="attribute_%NUMBER"]/td[@class="attribute-quantity"]//input',
    ...
    combination_email_checkbox: '//*[@id="combination_%NUMBER_attribute_low_stock_alert"]',
    ...
    combination_priceTE: '//*[@id="combination_%NUMBER_attribute_price"]',
    ...
    combination_valid: '(//*[@id="combination_form_%NUMBER"]//li)[%V]',
    ...
    combination_name: '//*[@id="attribute_%NUMBER"]/td[3]',
    combination_image: '//*[@id="combination_%NUMBER_id_image_attr"]/div[2]/img',
    combination_image_checkbox: '(//*[@id="combination_%NUMBER_id_image_attr"]//input)[%POS]',
    combination_edit: '//*[@id="attribute_%NUMBER"]/td[7]/div[1]/a',
    combination_delete: '//*[@id="attribute_%NUMBER"]/td[8]/a[contains(@class, "delete")]',

module.exports = {
  ...
  CreateOrder: {
    ...
    new_customer_button: '//*[@id="search-customer-form-group"]//div[2]/a',
    detail_customer_button: '//*[@id="customers"]//div[2]/a',
    close_detail: '//a[@title="Close"]',
    close_detaill_cart: '//a[@title="Close"]',
    choose_customer_button: '//*[@id="customers"]/div[1]/div/div[2]/button',
    detail_cart: '//*[@id="nonOrderedCarts"]//tr/td[4]/a[1]',
    use_cart: '//*[@id="nonOrderedCarts"]//tr/td[4]/a[2]',
    orders_tab: '//*[@id="old_carts_orders_navtab"]/li[2]/a',
    detail_orders:'//*[@id="lastOrders"]/table/tbody/tr/td[7]/a[1]',
    use_orders:'//*[@id="lastOrders"]/table/tbody/tr/td[7]/a[2]',
    ...
    delete_product: '//*[@id="customer_cart"]//tr/td[5]//a[contains(@class,"delete_product")]',
    increaseqty_product: '//*[@id="customer_cart"]//tr/td[5]//a[contains(@class,"increaseqty_product")]',
    decreaseqty_product: '//*[@id="customer_cart"]//tr/td[5]//a[contains(@class,"decreaseqty_product")]',
    price_product: '//*[@id="customer_cart"]//tr/td[6]',
    currency: '//*[@id="id_currency"]',
    language: '//*[@id="id_lang"]',
    voucher: '//*[@id="voucher"]',
    delete_voucher: '//*[@id="voucher_list"]//a[contains(@class,"delete_discount")]',
    new_voucher_button: '//*[@id="vouchers_part"]/div[2]//div[2]/a',
    shipping_price: '//*[@id="shipping_price"]/b',
    edit_delivery_adress: '//*[@id="edit_delivery_address"]',
    detail_adresses: '//*[@id="address_delivery_detail"]',
    new_address_button: '//*[@id="new_address"]',
    delivery_address:'//*[@id="id_address_delivery"]',
    invoice_address:'//*[@id="id_address_invoice"]',
    free_shipping_button: '//*[@id="carrier_form"]/div[3]/div//label[@for="free_shipping%S"]',
    total_products: '//*[@id="total_products"]',
    total_vouchers: '//*[@id="total_vouchers"]',
    total_taxes: '//*[@id="total_taxes"]',
    total_tax_excl: '//*[@id="total_without_taxes"]',
    total_tax_incl: '//*[@id="total_with_taxes"]',
